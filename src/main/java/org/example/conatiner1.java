...
public class conatiner1 {
    ...
    private By ClickZones =By.xpath("//*[@id=\"root\"]/div/div/div[2]/div/div[1]/div[1]/div[2]/div/div/div/div/div[5]/div/div");
...
//    }
    ...
    public void ClearEnterTheLatitude()
    {
        WebElement CLEARLATITUDE= wait.until(ExpectedConditions.visibilityOfElementLocated(EnterLatitude));
        CLEARLATITUDE.clear();
    }
    ...
    public void ClearEnterTheDistictName()
    {
        WebElement CLEARDISTICT= wait.until(ExpectedConditions.visibilityOfElementLocated(Enterdistictname));
        CLEARDISTICT.clear();
    }
